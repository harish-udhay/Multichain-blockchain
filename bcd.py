...
class BcD(tk.Tk):
	...
	def Start(self):
		...
		tk.Label(Footer, text='Harish Udhaya KUmar | Swathi Gopal | Pragun', font='Fixedsys 7 bold', bg='black', fg='gray50', bd=0).grid(row=2, column=0)
		tk.Label(Footer, text='Contact', font='Verdana 7 underline', bg='black', fg='gray40', bd=0).grid(row=3, column=0)
		tk.Label(Footer, text='harish.udhayakumar@rutgers.edu', font='Fixedsys 7 bold', bg='black', fg='gray50', bd=0).grid(row=4, column=0)
	...
	def SignUp(self, uid, pword, passPh):
		...
		url = 'http://localhost/Blockchain-Database/server_files/signup.php'
	...
	def CheckLogin(self, uid, pword, stud):
		...
		url = 'http://localhost/Blockchain-Database/server_files/login.php'
	...
	def getGrades(self):
		url = 'http://localhost/Blockchain-Database/server_files/view.php'
		try:
	...
	def submitG(self, grades):
		...
		url = 'http://localhost/Blockchain-Database/server_files/insert.php'
		try:
	...
	def updateG(self, event):
		...
		url = 'http://localhost/Blockchain-Database/server_files/update.php'
		try:
	...
	def Logout(self):
		url = 'http://localhost/Blockchain-Database/server_files/logout.php'
		try:
			response = self.sess.post(url)
		except (ConnectionError, requests.exceptions.RequestException) as e:
			self.footer.config(text='Some Error has Occurred !', bg='red2', fg='white', relief='raised')
